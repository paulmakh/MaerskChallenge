...
namespace UnitTests
{
    ...
    {
        private readonly SortingBackgroundService _sortingService;
        public SortingBackgroundServiceTest()
        {
            var loggerMock = new Mock<ILogger<SortingBackgroundService>>();

            _sortingService = new SortingBackgroundService(null, loggerMock.Object);
        }
        ...
        public void SortInputArray(int[] inputArray, int[] expectedArray)
        {
            ...
            _sortingService.ExecuteSorting(job);
